...
public class DataBaseGoodsHelper extends SQLiteOpenHelper {

    // путь к базе данных вашего приложения
    private static String DB_PATH = "/data/data/ru.goodibunakov.itravel/databases/";
    private static String DB_NAME = "goods";
    private static final int DB_VERSION = 1; // версия базы данных
    private SQLiteDatabase goodsDatabase;
     ...
     * @param context
     */
    public DataBaseGoodsHelper(Context context) {
    ...
    public void openDataBase() throws SQLException {
        ...
        goodsDatabase = SQLiteDatabase.openDatabase(myPath, null, SQLiteDatabase.OPEN_READONLY);
    }
